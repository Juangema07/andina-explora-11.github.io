...
const places=[
 {id:'valle',name:'Valle del Cauca',tag:'Valle interandino · Río · Producción',image:images.valle,position:'left:18.2%;top:34.5%;width:17.7%;height:9.9%;',questions:[
 ...
 {id:'cafe',name:'Eje Cafetero',tag:'Montañas · Agricultura · Café',image:images.cafe,position:'left:39.1%;top:38.7%;width:17.6%;height:10%;',questions:[
 ...
 {id:'paramo',name:'Páramo',tag:'Alta montaña · Agua · Biodiversidad',image:images.paramo,position:'left:69.5%;top:12%;width:18.6%;height:9.6%;',questions:[

...
const otherGamesScript=document.createElement('script');otherGamesScript.src='./otros-juegos.js?v=20260913-2';otherGamesScript.defer=true;document.head.appendChild(otherGamesScript);
})();
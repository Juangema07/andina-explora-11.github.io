(()=>{
'use strict';
// Hay dos referencias históricas a este archivo en index.html. Conservamos la primera y anulamos la siguiente antes de que se ejecute.
const current=document.currentScript;
[...document.scripts].forEach(s=>{if(s!==current&&s.src.includes('andina-image-fix.js'))s.remove()});
...
const CORDS={
 ...
 central:{name:'Cordillera Central',place:'Paisaje de la Cordillera Central · Quindío',img:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Cordillera_Central_-_Quind%C3%ADo_-_Colombia_(14749295421).jpg',source:'https://commons.wikimedia.org/wiki/File:Cordillera_Central_-_Quind%C3%ADo_-_Colombia_(14749295421).jpg',credit:'Foto: Alejandro Bayer Tamayo · Wikimedia Commons'},
 oriental:{name:'Cordillera Oriental',place:'Paisaje de la Cordillera Oriental · Colombia',img:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Cordillera_oriental_Colombia.jpg',source:'https://commons.wikimedia.org/wiki/File:Cordillera_oriental_Colombia.jpg',credit:'Foto: Mpbonillap · Wikimedia Commons · CC BY-SA 4.0'}
};
function cordStyle(){if(document.getElementById('cord-direct-css'))return;const s=document.createElement('style');s.id='cord-direct-css';s.textContent=`
#cordilleras-reales-direct{margin:0 auto 5rem;max-width:1200px;padding:0 28px}
#cordilleras-reales-direct .cr-head{display:flex;justify-content:space-between;gap:30px;align-items:end;margin-bottom:22px}
#cordilleras-reales-direct h2{font-size:clamp(2rem,4vw,3.4rem);margin:.25rem 0}#cordilleras-reales-direct .cr-head p{max-width:480px;opacity:.78}
#cordilleras-reales-direct .cr-tabs{display:flex;gap:10px;flex-wrap:wrap;margin-bottom:16px}#cordilleras-reales-direct .cr-tabs button{border:1px solid #ffffff30;background:#ffffff10;color:inherit;padding:12px 18px;border-radius:999px;cursor:pointer;font:inherit;font-weight:700;transition:.2s}#cordilleras-reales-direct .cr-tabs button.active{background:#d8a84e;color:#16251f;border-color:#d8a84e}
#cordilleras-reales-direct .cr-view{display:grid;grid-template-columns:minmax(0,1.65fr) minmax(260px,.75fr);min-height:430px;border-radius:28px;overflow:hidden;background:#10271f;box-shadow:0 20px 60px #0002}
#cordilleras-reales-direct figure{margin:0;min-height:430px;position:relative;background:#152e26}#cordilleras-reales-direct img{width:100%;height:100%;min-height:430px;display:block;object-fit:cover}#cordilleras-reales-direct figcaption{position:absolute;left:0;right:0;bottom:0;padding:38px 20px 16px;color:white;background:linear-gradient(transparent,#000b);font-size:.82rem}#cordilleras-reales-direct figcaption a{color:inherit}
#cordilleras-reales-direct .cr-info{padding:38px 30px;color:white;display:flex;flex-direction:column;justify-content:center}.cr-info h3{font-size:2rem;margin:8px 0}.cr-info p{opacity:.75}.cr-info a{color:#e9c477;margin-top:15px}
